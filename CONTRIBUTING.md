...
`<label class="section-header"><?php esc_html_e( 'Other', 'dt-oikos' )?></label>`
...
update the [starter plugin](https://github.com/thecodezone/dt-oikos) `phpcs.xml`, you might want to look there to get
the latest version.

### GitHub and Commits

For new plugins copy our [starter plugin](https://github.com/thecodezone/dt-oikos).
